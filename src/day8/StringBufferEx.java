...
public class StringBufferEx {
    public static void main(String[] args) {
        //StringBuffer 의 기본사이즈는 16개의 문자를 정장할 수 있다.
        ...
        sb1.append("1111111111111111111111111111111");
        System.out.println(sb1.capacity());
        result = sb1.toString();
        System.out.println(result);

        String str = "abcdefg";
        StringBuffer sb2 = new StringBuffer(str);   //String -> StringBuffer 클래스로 형변환
        System.out.println("처음 상태 " +sb2);

        System.out.println(sb2.toString()); //StringBuffer -> Strnig
