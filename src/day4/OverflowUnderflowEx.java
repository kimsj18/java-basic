...
public class OverflowUnderflowEx {
    public static void main(String[] args) {
        byte b1 = 125;
        for(int i =0 ; i < 5 ; i++) {//for문 안에서 작동할 변수 만듦
            b1++;   //b = b+1
            System.out.println("i의 값 =" + i + " " + "b1: " + b1);
        }
            int apple = 1;
            double pieceUnit = 0.1;
            //사과 1개를 0.1 단위의 10조각으로 보고, 그 중 7조각을 학생들에게 나누어 주고 남은 양을 출력하려고 합니다.
            int stuNum = 7;
    ...
    // 타일의 범위내에서 연산이 수행되도록 신경써야 합니다.
    // 만약 정수에서 발생할 가능성이 있다면 long 타입으로 연산하도록 합니다.
}
