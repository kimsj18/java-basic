...
public class FormatEx {
    public static void main(String[] args) {
        ...
        String result2 = text2.replaceAll("[^a-z0-9]", "0"); //영문자와 숫자를 제외한 문자를 모두 0 으로 치환}
