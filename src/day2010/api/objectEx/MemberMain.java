...
public class MemberMain extends Object {
...
//        }
        ...
        //현재, Member 클래스에서 equals()와 hashcode()를 오버라이딩했기때문에, 두 객체 필드 name의 해시코드를 반환한값이다.
        ...
        //Collection(HashMap, HashSet, HashTable)은 객체가 논리적으로 같은지를 비료할때 hashcode() -> equals()
    }
}
